...
<div class="container-fluid">
	...
	<form action="{{ route('blog.admin.store') }}" method="post" enctype="multipart/form-data">
		...
		<div class="row">
							...
							<div class="card-body p-4">
								<div class="row">
									<div class="form-group col-md-12">
										...
										<input type="text" name="data[Blog][title]" class="form-control" id="BlogTitle" placeholder="{{ __('Title') }}" value="{{ old('data.Blog.title') }}">
           ...
           {{-- //############################################################################## --}}
                                     <div class="form-group col-md-12">
										<label for="ContentTitle">{{ __('Title English') }}</label>
										<input type="text" name="title" class="form-control" id="ContentTitle2" placeholder="{{ __('Title') }}" value="{{ old('data.Page.title') }}">
                                    ...
                                    <div class="form-group col-md-12">
										<textarea name="content" class="form-control W3cmsCkeditor h-auto" id="PageContent2" rows="10">{{ old('data.Page.content') }}</textarea>
