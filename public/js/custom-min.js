(function($) {
	...
	var W3cms = function(){
		...
		var handleCkEditor = function(){
			...
			// if(jQuery('.W3cmsCkeditor2').length > 0 && typeof enableCkeditor !== undefined && enableCkeditor == true)
			// {
				CKEDITOR.replace( jQuery('#PageContent2').attr('id'), {
            ...
            // if(jQuery('.W3cmsCkeditor3').length > 0 && typeof enableCkeditor !== undefined && enableCkeditor == true)
			// {
