            ...
            <div class="col-xl-3 col-lg-3 col-sm-12">
                <div class="footer-widget footer-black">
                    <div class="footer-desc-wrap">
                        <a href="index.html"><img src="{{theme_asset('assets/images/logo-2.svg')}}" alt=""></a>
                        <p class="footer-desc">Conditions Terms of Use Our Services New Guests List The Team List</p>
                        <div class="footer-btn-wrap">
                            <a class="common-btn" href="{{route('front.contact')}}">
                                <span>Contact
            ...
            <div class="col-xl-2 col-lg-3 col-sm-6">
                <div class="footer-widget footer-black">
                    ...
                    <ul class="footer-list footer-address">
                        <li>تهران، خیابان ولی عصر، ابتدای خیابان مطهری، پلاک 482، طبقه سوم</li>
                        <li>
